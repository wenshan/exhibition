...
var sightglass = require('../../../common/sightglass');
...
_ref = 'on' in $.prototype ?
    ['on', 'off'] :
    ['bind', 'unbind'], bindMethod = _ref[0], unbindMethod = _ref[1];
...
Rivets.View = (function() {
    function View(els, models, options) {
        ...
        if (!(this.els instanceof $ || this.els instanceof Array)) {
            this.els = [this.els];
        }
...
module.exports = Rivets.factory(sightglass);

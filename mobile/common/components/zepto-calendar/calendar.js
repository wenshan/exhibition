...
var Calendar = function(params) {
    ...
    p.updateValue = function() {
        ...
        for (i = 0; i < p.value.length; i++) {
            ...
            var mon = valueDate.getMonth() + 1;
            mon = mon > 9 ? mon : ('0' + mon);
            var day = valueDate.getDate();
            day = day > 9 ? day : ('0' + day);

            var date = valueDate.getFullYear() + '-' + mon + '-' + day;

            p.wrapper.find('.picker-calendar-day[data-date="' + (date) + '"]').addClass('picker-calendar-day-selected');
        }
    ...
    p.initCalendarEvents = function() {
        ...
        function handleDayClick(e) {
            ...
            p.addValue(new Date([dateYear, dateMonth, dateDay].join('-')).getTime());
    ...
    p.monthHTML = function(date, offset) {
        ...
        for (i = 1; i <= rows; i++) {
            ...
            for (j = 1; j <= cols; j++) {
                ...
                rowHTML += '<div data-year="' + dayYear + '" data-month="' + dayMonth + '" data-day="' + dayNumber + '" class="picker-calendar-day' + (addClass) + '" data-date="' + (dayYear + '-' + dayMonth + '-' + dayNumber) + '"><span><p class="eh-date-day">' + dayNumber + '</p><div class="eh-has-date" data-role="has-date"></div></span></div>';
            }
    ...
    p.updateCurrentMonthYear = function(dir) {
        ...
        p.container.find('.current-month-value').text(p.params.monthNames[p.currentMonth] + ' ' + p.currentYear);
    ...
    p.nextMonth = function(transition) {
        ...
        // 超过12个月不再执行
        if (moment(nextDate).diff(moment(), 'M') > 11) {
            return;
        }
    ...
    p.prevMonth = function(transition) {
        ...
        // 超过12个月不再执行
        if (moment().diff(moment(prevDate), 'M') > 11) {
            return;
        }

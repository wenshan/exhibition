...
require('../zepto-modals/modals');

var AccoutInfo = require("/mobile/common/account-info-m/account-info-m");
...
module.exports = {
    ...
    _searchFuncInit: function() {
        ...
        var events = {
            ...
            'click [data-role="login"]': 'jumpToLogin'
        };

        this.events = $.extend(this.events || {}, events);

        this._initAccountLeft();
    },
    ...
    _initAccountLeft: function() {
        new AccoutInfo({
            isLogined: this.get('isLogined')
        });
    },
    ...
    // 页面跳转到后台首页公共方法
    _jump: function(q, country, industry, noFilter) {
        ...
        if (noFilter) {
            ...
            country = country || this._selectedCountry;
            industry = industry || this._selectedCategory;
        }

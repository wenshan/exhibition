...
(function(factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        module.exports = factory(require('alpha-jquery/jquery'), require('alpha-moment/moment'));
    } else {
    ...
    */
    ...
    var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
        ...
        renderNumberCellHtml: function(date) {
            ...
            return '' +
                ...
                '<span class="fc-day-date-corner" data-val="' + date.format() + '">' +
                date.date() +
                '</span></td>';
        },
    ...
    DayGrid.mixin({
        ...
        renderFgSegs: function(segs) {
            ...
            $.each(segs, function(index, item) {
                $('[data-val="' + moment(item.eventStartMS).format('YYYY-MM-DD') + '"].fc-day-date-corner').addClass('active');
            });
        ...
        fgSegHtml: function(seg, disableResizing) {
            ...
            return '<a class="' + classes.join(' ') + '"' +
                ...
                '>' +
                '<div class="fc-content" data-extra=\'' + JSON.stringify(event.extra) + '\'>' +
                (this.isRTL ?
    ...
    function Calendar_constructor(element, overrides) {
        ...
        var defaultDate = userOptions.defaultDate || moment().format('YYYY-MM');
        var rangeSet = userOptions.rangeSet || 11;

        function prev() {
            var diff = moment(date.format('YYYY-MM')).diff(defaultDate, 'M');
